...
st.title('Concept Drift Detection Using ADWIN in a Synthetic Dataset')
st.write("""
This app simulates concept drift detection using the ADWIN method on a synthetic dataset.
...
with col1:
    ...
    st.write(f"Drift Detector: ADWIN")
