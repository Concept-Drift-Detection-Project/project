...
st.title('Concept Drift Detection Using Page Hinkley in a Synthetic Dataset')
st.write("""
This app simulates concept drift detection using the Page Hinkley method on a synthetic dataset.
...
with col1:
    ...
    st.write(f"Drift Detector: Page Hinkley")
    ...
    # Sidebar for Page Hinkley configuration
...
if st.button("Check for Drift"):
    ...
    for i in range(len(X_stream)):
        ...
        # Update Page Hinkley with the error 
