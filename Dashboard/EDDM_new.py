...
st.title('Concept Drift Detection Using EDDM in a Synthetic Dataset')
st.write("""
This app simulates concept drift detection using the EDDM method on a synthetic dataset.
...
with col1:
    ...
    st.write(f"Drift Detector: EDDM")
...
if st.button("Check for Drift"):
    ...
    average_detection_delay = detection_delay =(detection_delays[0]) if detection_delays else None
